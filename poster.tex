    ...
    \begin{columns}
        ...
        \block{Motivation}{
            ...
            \begin{itemize}
                ...
                \item \textbf{Hamiltonian Monte Carlo} algorithm applies Newton's laws of motion to methodically traverse the space and \textbf{avoid random walk behaviour}
        ...
        \block{Performance of HMC versus MCMC}{
            ...
            \begin{multicols*}{2}
                ...
                \begin{itemize}
                    ...
                    \item Measured effiency as \textbf{effective sample size} of tree length per unit time
        ...
        \block{Future Work}{
            \begin{itemize}
                ...
                \item Automatic tuning of HMC algorithm for optimal performance, esp. the skater's mass $\mat M$
                \item Implementing and testing more sophisticated flavours of HMC
        ...
        \begin{multicols*}{2}
            ...
            \qrcode[height=5cm]{10.6084/m9.figshare.1473743}
