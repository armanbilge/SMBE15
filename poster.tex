    ...
    \begin{columns}
        ...
        \block{HMC versus MCMC}{
            ...
            \centering
                \begin{tikzpicture}
                    % Tree
                    \draw [line width=1mm] (2.5,18) -- (2.5,20);
                    \draw [line width=1mm] (5.5,18) -- (5.5,20);
                    \draw [line width=1mm] (2.5,20) -- (5.5,20);
                    \draw [line width=1mm] (4,20) -- (4,22);
                    \draw [line width=1mm] (8.5,18) -- (8.5,22);
                    \draw [line width=1mm] (4,22) -- (8.5,22);
                    \draw [line width=1mm] (6.25,22) -- (6.25,23);
                    \draw [ultra thick, dashed] (2.5,18) -- (10,18);
                    \draw [ultra thick, dashed] (2.5,20) -- (10,20);
                    \draw [ultra thick, dashed] (2.5,22) -- (10,22);
                    \node at (10,19) {$t_2$};
                    \node at (10,21) {$t_1$};

                    % Legend
                    \draw [line width=1mm, red] (16,23) -- (17,23);
                    \draw [line width=1mm, violet] (16,22) -- (17,22);
                    \node [text=red, right] at (17.125,23) {\textbf{HMC}};
                    \node [text=violet, right] at (17.125,22) {\textbf{MCMC}};
